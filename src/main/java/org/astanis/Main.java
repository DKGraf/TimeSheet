...
//        }
        WorkingTimeDataSet wdt = new WorkingTimeDataSet(2018, 1, 1, 640);

        EmployeeDataSet employee1 = new EmployeeDataSet();

//        wdt.setEmployee(employee1);

        employee1.setWorkingHours(List.of(wdt));
        employee1.setName("AAAAA");
        employee1.setDepartment("BBBBB");
        employee1.setGender(true);
        employee1.setPersonalNumber(1);
...
//        dbService.save(employee3);
        ...
        System.out.println(dbService.readById(1));
